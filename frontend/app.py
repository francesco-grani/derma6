"""Entry point for the Skincare Routine Builder Streamlit app.
...
from frontend.utils import inject_css, render_sidebar_header
...
if "username" not in st.session_state:
    ...
    with st.container(horizontal_alignment="center"):
        st.space("large")
        st.title(":material/face: Skincare Routine Builder")
        st.caption("Your personal skincare assistant for male beginners.")
        st.space("small")
